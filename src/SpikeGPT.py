...
class Block(nn.Module):
    def __init__(self, config, layer_id):
        ...
        self.lif1 = neuron.LIFNode(tau=2., surrogate_function=surrogate.ATan(alpha=2.0), step_mode='m',
                                            v_threshold=1.)
        self.lif2 = neuron.LIFNode(tau=2., surrogate_function=surrogate.ATan(alpha=2.0), step_mode='m',
                                            v_threshold=1.)
